...
remote_state {
  ...
  config = {
    address        = "https://gitlab.com/api/v4/projects/3226/terraform/state/dev_gke_terraform.tfstate"
    lock_address   = "https://gitlab.com/api/v4/projects/3226/terraform/state/dev_gke_terraform.tfstate/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/3226/terraform/state/dev_gke_terraform.tfstate/lock"
...
inputs = {
  ...
  node_pools                           = [{ name = "default-node-pool", machine_type = "n2-standard-2" }]
  node_pools_tags                      = { all = [] }
