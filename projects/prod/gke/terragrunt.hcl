...
remote_state {
  ...
  config = {
    address        = "https://swissknife.vip/api/v4/projects/3226/terraform/state/prod_gke_terraform.tfstate"
    lock_address   = "https://swissknife.vip/api/v4/projects/3226/terraform/state/prod_gke_terraform.tfstate/lock"
    unlock_address = "https://swissknife.vip/api/v4/projects/3226/terraform/state/prod_gke_terraform.tfstate/lock"
...
inputs = {
  ...
  region                               = "asia-east1"
  zone                                 = "asia-east1-a"
  cluster_name_suffix                  = "rpa-prod-cluster"
  network                              = "prod"
  subnetwork                           = "bi-rpa-prod"
  ip_range_pods                        = "gke-pods"
  ip_range_services                    = "gke-service"
  enable_binary_authorization          = false
  regional                             = false
  kubernetes_version                   = "latest"
  name                                 = "rpa-prod-cluster"
  zones                                = ["asia-east1-a"]
  ...
  service_account                      = "gke-cluster-sa@gcp-20240322-002.iam.gserviceaccount.com"
