...
remote_state {
  ...
  config = {
    address        = "https://gitlab.com/api/v4/projects/3226/terraform/state/prod_gke_terraform.tfstate"
    lock_address   = "https://gitlab.com/api/v4/projects/3226/terraform/state/prod_gke_terraform.tfstate/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/3226/terraform/state/prod_gke_terraform.tfstate/lock"
