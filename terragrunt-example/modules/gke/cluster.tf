...
resource "google_container_cluster" "primary" {
  ...
  ip_allocation_policy {
    cluster_secondary_range_name  = "goap-svc-range"
    services_secondary_range_name = "goap-pod-range"
  }
  ...
  description     = "goap public cluster"       // 叢集描述
